...
function ProjectPage({ project }: {project: SanityDocument}) {
      return(
        <div className="w-full md:m-5 m-0 mb-5 flex flex-col justify-center items-center">
          ...
          <div className="lg:w-[80vw] w-[90vw] flex flex-row justify-between items-center">
          ...
          <div className="w-[80vw] flex lg:flex-row flex-col justify-between items-start mt-8">
